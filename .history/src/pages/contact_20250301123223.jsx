        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            ...
            >
              ...
              <button className="bg-[#413D66] text-white rounded-[30px] py-[8px] md:py-[10px] px-[16px] md:px-[20px] flex items-center justify-center gap-1 mx-auto md:mx-0 hover:bg-[#363156] transition-colors">
                <svg
                  width="32"
                  height="20"
                  viewBox="0 0 47 47"
                  className="md:w-[30px] md:h-[20px]"
                  fill="none"
