...
const Hero = () => {
  return (
    <section className="relative bg-[#FFF7F2] w-full min-h-[580px] py-16 px-4">
      <div className="max-w-7xl mx-auto relative">
        {/* Left side with image */}
        <div className="absolute left-32 top-16">
          <div className="bg-[#F94917] rounded-[289px] w-[578px] py-[55px] px-[114px] flex justify-center items-center">
            <img
              src="/api/placeholder/349/407"
              alt="Kalorize App Interface"
              className="w-[349px] h-[407px] object-contain"
            />
          </div>
        </div>

        {/* Right side content */}
        <div className="ml-[827px] pt-32 max-w-[600px]">
          <h1 className="text-[41px] font-extrabold text-[#413D66] leading-[62px] font-inter mb-5">
            Penuhi Kebutuhan Gizi Kamu dengan Kalorize
          </h1>
          <p className="text-2xl font-bold text-[#F94917] leading-9 font-inter">
            Pilihan Sehat, Rekomendasi Tepat
          </p>

          {/* Contact Button */}
          <div className="mt-20">
            <button className="bg-[#413D66] text-white rounded-[46px] py-[14px] px-[23px] flex items-center justify-center gap-2 min-w-[447px] hover:bg-[#363156] transition-colors">
              <span className="text-2xl font-bold leading-9">Hubungi Kami</span>
              <svg
                width="47"
                height="47"
                viewBox="0 0 47 47"
