          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            ...
            <div className="relative -mb-0 md:-mb-24 scale-100 md:scale-100 -mt-12 md:mt-0">
              ...
              <img
                ...
                alt="Kalorize App"
                className="absolute top-[175px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[187px] md:w-[204px]"
              />
            </div>
            ...
            >
              <h1 className="text-xl md:text-[24px] font-extrabold text-[#413D66] leading-[1.4] font-inter">
