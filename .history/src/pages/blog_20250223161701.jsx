        ...
        <div className="relative px-0">
          ...
          <div className="flex gap-5">
            ...
            {blogPosts.map((post, index) => (
              <div
                key={index}
                className={`w-[330px] flex-none bg-white rounded-lg overflow-hidden shadow-md transition-opacity duration-300 p-5 ${
              ...
              >
                <div className="relative rounded-lg overflow-hidden">
                  <img
                    src={post.image}
                    alt={post.title}
                    className="w-full h-[280px] object-cover" // Mengubah tinggi gambar
                  />
