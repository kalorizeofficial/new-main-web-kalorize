...
function Contact() {
  return (
    <section className="py-8 md:py-16 bg-white">
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-32 md:py-8 mb-8 md:mb-16 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            {/* Left side - Stacked images */}
            <div className="relative -mb-0 md:-mb-24 scale-100 md:scale-100 -mt-16 md:mt-0">
              {/* Circle background */}
