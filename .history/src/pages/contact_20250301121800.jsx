      ...
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-28 md:py-8 mb-8 md:mb-16 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            ...
            {/* Right side - Content */}
            <div
              className="flex flex-col space-y-4 md:space-y-6 max-w-[400px] md:max-w-[400px] text-left md:text-left -mt-10 md:mt-0
                          md:bg-transparent bg-[#FFF7F2] rounded-lg px-4 py-4 md:p-4 relative z-10"
            >
              ...
              <button className="bg-[#413D66] text-white rounded-[30px] py-[12px] px-[24px] flex items-center justify-center gap-1 mx-auto md:mx-0 hover:bg-[#363156] transition-colors scale-90 md:scale-100">
                <svg
                  width="40"
                  height="24"
                  viewBox="0 0 47 47"
