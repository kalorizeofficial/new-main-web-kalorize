...
function Contact() {
  return (
    <section className="py-16 bg-white">
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-8 py-8 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-16">
            ...
            <div className="flex flex-col space-y-6 max-w-[400px]">
              ...
              <p className="text-base font-bold text-[#F94917] leading-normal font-inter">
