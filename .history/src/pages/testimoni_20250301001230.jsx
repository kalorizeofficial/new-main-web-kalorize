...
const Testimonial = () => {
  ...
  return (
    <section className="py-8 md:py-16 bg-white">
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-6 md:py-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center gap-4 mt-4">
              <button
                onClick={prevSlide}
                className="bg-[#413D66] rounded-full p-1.5 shadow-md hover:bg-opacity-90 z-20"
              >
