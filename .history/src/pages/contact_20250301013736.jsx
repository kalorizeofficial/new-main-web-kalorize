      ...
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-8 mb-8 md:mb-16 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            ...
            <div className="relative -mb-0 md:-mb-24 scale-100 md:scale-100 -mt-20 md:mt-0">
              {/* Circle background */}
              <div className="bg-[#F94917] rounded-full w-[320px] md:w-[400px] h-[320px] md:h-[400px] translate-y-0 p-8 md:p-10 pt-24 md:pt-10" />
