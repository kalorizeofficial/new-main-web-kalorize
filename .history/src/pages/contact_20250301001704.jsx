      ...
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-8 mb-8 md:mb-16 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            ...
            <div className="relative -mb-12 md:-mb-24 scale-75 md:scale-100">
              {/* Circle background */}
              <div className="bg-[#F94917] rounded-full w-[300px] md:w-[400px] h-[300px] md:h-[400px] translate-y-0" />

              {/* Phone image positioned on top of circle */}
              <img
                src="/phone.png" // Replace with your actual image path
                alt="Kalorize App"
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[180px] md:w-[240px]"
              />
            </div>

            {/* Right side - Content */}
            <div className="flex flex-col space-y-4 md:space-y-6 max-w-[300px] md:max-w-[400px] text-center md:text-left mt-8 md:mt-0">
              ...
              <button className="bg-[#413D66] text-white rounded-[30px] py-[15px] px-[30px] flex items-center justify-center gap-1 w-fit hover:bg-[#363156] transition-colors">
                <svg
                  width="50"
                  height="30"
                  viewBox="0 0 47 47"
