      ...
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-28 md:py-8 mb-8 md:mb-16 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            ...
            {/* Right side - Content */}
            <div
              className="flex flex-col space-y-2 md:space-y-6 max-w-[300px] md:max-w-[400px] text-center md:text-left -mt-10 md:mt-0
                          md:bg-transparent bg-[#FFF7F2] rounded-lg p-2 md:p-4 relative z-10"
            >
