        ...
        <div className="relative">
          <div className="flex gap-6 mb-8">
            {blogPosts.map((post, index) => (
              <div
                key={index}
                className={`bg-white rounded-lg overflow-hidden shadow-sm transition-opacity duration-300 flex flex-col items-start w-[523px] h-[754px] p-[33px] pb-[44px] gap-[44px] flex-shrink-0 ${
