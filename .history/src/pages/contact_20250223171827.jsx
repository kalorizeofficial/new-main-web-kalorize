...
function Contact() {
  return (
    <section className="py-16 bg-white">
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-8 py-8 mb-24 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-center gap-16">
            {/* Left side - Stacked images */}
            <div className="relative -mb-24">
              {/* Circle background */}
              <div className="bg-[#F94917] rounded-full w-[400px] h-[400px] translate-y-0" />

              {/* Phone image positioned on top of circle */}
              <img
                src="/phone.png" // Replace with your actual image path
                alt="Kalorize App"
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[240px]"
              />
            </div>
            ...
            <div className="flex flex-col space-y-6 max-w-[400px]">
              ...
              <p className="text-sm font-bold text-[#F94917] leading-normal font-inter">
