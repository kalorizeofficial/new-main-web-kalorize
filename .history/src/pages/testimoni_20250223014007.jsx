...
const Testimonial = () => {
  ...
  return (
    <section className="py-16 bg-white">
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-8 py-12">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-[36px] font-bold text-center text-[#1F1C14] mb-12">
          ...
          <div className="relative">
            <button
              onClick={prevSlide}
              className="absolute -left-12 top-1/2 -translate-y-1/2 bg-[#413D66] rounded-full p-2 shadow-md hover:bg-opacity-90 z-20"
            >
            ...
            <button
              onClick={nextSlide}
              className="absolute -right-12 top-1/2 -translate-y-1/2 bg-[#413D66] rounded-full p-2 shadow-md hover:bg-opacity-90 z-20"
            >
