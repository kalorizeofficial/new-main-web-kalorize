        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            ...
            >
              ...
              <button className="bg-[#413D66] text-white rounded-[30px] py-[12px] md:py-[15px] px-[20px] md:px-[30px] flex items-center justify-center gap-1 mx-auto md:mx-0 hover:bg-[#363156] transition-colors">
                <svg
                  width="40"
                  height="24"
                  viewBox="0 0 47 47"
