...
function Contact() {
  return (
    <section className="py-8 md:py-16 bg-white">
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-28 md:py-8 mb-8 md:mb-16 overflow-hidden">
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16">
            {/* Left side - Stacked images */}
            <div className="relative -mb-0 md:-mb-24 scale-100 md:scale-100 -mt-12 md:mt-0">
              {/* Circle background */}
              <div className="bg-[#F94917] rounded-full w-[320px] md:w-[400px] h-[320px] md:h-[400px] translate-y-0 p-8 md:p-10" />

              {/* Phone image positioned on top of circle */}
              <img
                src="/phone.png" // Replace with your actual image path
                alt="Kalorize App"
                className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[45%] md:-translate-y-1/2 w-[190px] md:w-[240px]"
              />
            </div>

            {/* Right side - Content */}
            <div
              className="flex flex-col space-y-2 md:space-y-6 max-w-[300px] md:max-w-[400px] text-center md:text-left mt-4 md:mt-0
                          md:bg-transparent bg-[#FFF7F2] rounded-lg px-1 pt-4 pb-2 md:p-4 relative z-10"
            >
              <h1 className="text-[26px] md:text-2xl font-extrabold text-[#413D66] leading-[1.4] font-inter">
              ...
              <button className="bg-[#413D66] text-white rounded-[30px] py-3 md:py-[15px] px-6 md:px-[30px] flex items-center justify-center gap-1 mx-auto md:mx-0 hover:bg-[#363156] transition-colors">
                <svg
                  width="50"
                  height="30"
                  viewBox="0 0 47 47"
