          ...
          <div className="relative">
            ...
            <div className="overflow-hidden">
              <div className="flex items-center justify-center min-h-[350px] md:min-h-[400px]">
                <div className="md:flex md:gap-4 md:items-center md:justify-center w-full">
                  {/* Mobile wrapper */}
                  <div
                    className="flex md:hidden transition-transform duration-300 ease-in-out gap-4"
                    style={{
                  ...
                  >
                    {testimonials.map((testimonial, index) => (
                      <div key={index} className="w-full flex-shrink-0">
                        <div className="bg-white rounded-lg px-3 md:px-5 py-4 md:py-5 shadow-lg text-center max-w-[280px] mx-auto">
