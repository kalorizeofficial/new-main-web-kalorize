...
const Blog = () => {
  ...
  return (
    <section className="py-16 px-4">
      <div className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-8 py-8">
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-12 bg-white rounded-full p-2 shadow-md hover:bg-gray-50 text-gray-800"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-12 bg-red-500 rounded-full p-2 shadow-md hover:bg-red-600 text-white"
          >
