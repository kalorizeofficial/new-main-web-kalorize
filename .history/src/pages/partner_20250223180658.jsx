const Partner = () => {
  ...
  return (
    <section className="pt-[164px] pb-20 px-4">
          ...
          {partners.map((partner, index) => (
            <div key={index} className="relative py-4">
              <img
                ...
                className="w-[232px] h-[140px] min-w-full min-h-full object-contain transition-shadow duration-200 hover:shadow-xl rounded-[25px]"
              />
            </div>
          ))}
        </div>
