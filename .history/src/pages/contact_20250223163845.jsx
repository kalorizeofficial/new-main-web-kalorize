...
const Hero = () => {
  return (
    <section className="relative bg-[#FFF7F2] w-full min-h-[400px] py-8 px-4">
      <div className="max-w-6xl mx-auto relative">
        {/* Left side with image */}
        <div className="absolute left-16 top-8">
          <div className="bg-[#F94917] rounded-[145px] w-[289px] py-[28px] px-[57px] flex justify-center items-center">
            <img
              src="/api/placeholder/175/204"
              alt="Kalorize App Interface"
              className="w-[175px] h-[204px] object-contain"
            />
          </div>
        </div>

        {/* Right side content */}
        <div className="ml-[414px] pt-16 max-w-[400px]">
          <h1 className="text-2xl font-extrabold text-[#413D66] leading-[1.4] font-inter mb-3">
          ...
          {/* Contact Button */}
          <div className="mt-10">
            <button className="bg-[#413D66] text-white rounded-[23px] py-[10px] px-[20px] flex items-center justify-center gap-2 min-w-[224px] hover:bg-[#363156] transition-colors">
