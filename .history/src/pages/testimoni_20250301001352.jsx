...
const Testimonial = () => {
  ...
  return (
    <section className="py-8 md:py-16 bg-white">
      <section className="max-w-5xl mx-auto bg-[#FFF7F2] rounded-2xl px-4 md:px-8 py-6 md:py-8 relative">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-[20px] md:text-[24px] font-inter font-extrabold text-center text-[#1F1C14] mb-6">
          ...
          <div className="relative">
            ...
            <button
              onClick={prevSlide}
              className="bg-[#413D66] rounded-full p-1.5 shadow-md hover:bg-opacity-90 z-20 absolute left-0 top-1/2 -translate-y-1/2 md:left-[-50px]"
            >
            ...
            <button
              onClick={nextSlide}
              className="bg-[#413D66] rounded-full p-1.5 shadow-md hover:bg-opacity-90 z-20 absolute right-0 top-1/2 -translate-y-1/2 md:right-[-50px]"
            >
                ...
                <div className="flex gap-2 items-center justify-center">
                  {testimonials.map((testimonial, index) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          transform: `translateX(${
                            ...
                            window.innerWidth >= 768 ? (isActive ? 1 : 0.8) : 1
                          })`,
                          opacity:
                      ...
                      >
                        <div className="bg-white rounded-lg px-4 md:px-5 py-4 md:py-5 shadow-lg text-center">
