        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center md:gap-16 pt-8 md:pt-0">
            ...
            >
              ...
              <button className="bg-[#413D66] text-white rounded-[30px] py-[8px] md:py-[12px] px-[16px] md:px-[24px] flex items-center justify-center gap-1 mx-auto md:mx-0 hover:bg-[#363156] transition-colors">
                <svg
                  width="32"
                  height="20"
                  viewBox="0 0 47 47"
