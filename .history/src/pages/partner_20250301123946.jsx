      ...
      <div className="max-w-8xl mx-auto overflow-x-auto">
        <div className="flex justify-start md:justify-center items-center gap-4 md:gap-20 md:flex-wrap min-w-min">
          {partners.map((partner, index) => (
            <div
              key={index}
              className="relative py-2 md:py-4 flex-shrink-0 w-[60px] h-[60px] md:w-[140px] md:h-[140px] bg-gray-100 rounded-[15px] md:rounded-[25px] transition-shadow duration-200 hover:shadow-xl"
            />
          ))}
        </div>
      </div>
