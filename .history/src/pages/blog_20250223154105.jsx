        ...
        <div className="relative">
          <div className="flex gap-6 mb-8">
            {blogPosts.map((post, index) => (
              <div
                key={index}
                className={`bg-white rounded-lg overflow-hidden shadow-sm transition-opacity duration-300 flex flex-col items-start w-[523px] h-[349px] p-4 gap-4 flex-shrink-0 ${
