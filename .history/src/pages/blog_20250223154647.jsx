        ...
        <div className="relative">
          <div className="flex gap-6 mb-8">
            {blogPosts.map((post, index) => (
              <div
                key={index}
                className={`w-1/3 bg-white rounded-lg overflow-hidden shadow-md transition-opacity duration-300 p-8 ${
              ...
              >
                <div className="relative rounded-lg overflow-hidden">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-white rounded-[2vw] px-2 py-1 flex items-center gap-1">
