  ...
  return (
    <section className="py-16 bg-white">
      ...
      <div className="max-w-5xl mx-auto rounded-2xl">
        {/* Judul section */}
        <h2 className="text-[24px] font-inter font-extrabold text-center text-[#413D66] pt-8 mb-12">
          Blog
        </h2>
        ...
        <div className="relative px-0">
          ...
          <div className="flex gap-5">
            ...
            {blogPosts.map((post, index) => (
              <div
                key={index}
                className={`w-[330px] h-[500px] flex-none bg-white rounded-lg overflow-hidden shadow-md transition-opacity duration-300 p-5 ${
                  index === currentSlide ? "opacity-100" : "opacity-100"
                }`}
              >
                <div className="h-[45%] relative rounded-lg overflow-hidden pb-4">
                  <img
                    src={post.image}
                    alt={post.title}
                ...
                <div className="h-[60%]">
                  <div className="mt-5">
                    ...
                    <h3 className="mt-2 text-lg font-inter font-extrabold text-gray-800">
                      {post.title}
                    </h3>
                    <p className="mt-2 text-gray-600 text-sm line-clamp-8">
                      {post.description}
                    </p>
                  </div>
                </div>
