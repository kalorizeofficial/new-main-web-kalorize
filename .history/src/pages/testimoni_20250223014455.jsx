...
const Testimonial = () => {
  ...
  return (
    <section className="py-16 bg-white">
      <section className="max-w-4xl mx-auto bg-[#FFF7F2] rounded-2xl px-8 py-12">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-[36px] font-bold text-center text-[#1F1C14] mb-6">
                ...
                <div className="flex gap-2 items-center justify-center">
                  {testimonials.map((testimonial, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="absolute transition-all duration-500 w-[10px]"
                        style={{
                      ...
                      >
                        <div className="bg-white rounded-lg px-5 py-6 shadow-lg text-center">
