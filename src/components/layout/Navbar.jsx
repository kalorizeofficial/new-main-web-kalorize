...
function Navbar() {
  ...
  const [isDropdownOpenProdukMobile, setisDropdownOpenProdukMobile] =
    useState(false);

  const [isDropdownOpenMakanan, setisDropdownOpenMakanan] = useState(false);
  const [isDropdownOpenMakananMobile, setisDropdownOpenMakananMobile] =
    useState(false);

  const [isDropdownOpenBermitra, setisDropdownOpenBermitra] = useState(false);
  const [isDropdownOpenBermitraMobile, setisDropdownOpenBermitraMobile] =
    useState(false);
  ...
  const handleClickOutside = useCallback((event) => {
    if (
      menuRefProduk.current &&
      !menuRefProduk.current.contains(event.target)
    ) {
      setisDropdownOpenProduk(false);
    }
    if (
      menuRefMakanan.current &&
      !menuRefMakanan.current.contains(event.target)
    ) {
      setisDropdownOpenMakanan(false);
    }
    if (
      menuRefBermita.current &&
      !menuRefBermita.current.contains(event.target)
    ) {
      setisDropdownOpenBermitra(false);
    }
    if (
      menuRefMobileProduk.current &&
      !menuRefMobileProduk.current.contains(event.target)
    ) {
      setisDropdownOpenProdukMobile(false);
    }
    if (
      menuRefMobileMakanan.current &&
      !menuRefMobileMakanan.current.contains(event.target)
    ) {
      setisDropdownOpenMakananMobile(false);
    }
    if (
      menuRefMobileBermitra.current &&
      !menuRefMobileBermitra.current.contains(event.target)
    ) {
      setisDropdownOpenBermitraMobile(false);
    }
  }, []);
    ...
    <nav className="bg-white">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 px-3">
            ...
            <div className="flex font-medium p-4 md:p-0 mt-4 bg-gray-200 md:space-x-8 md:flex-row md:mt-0 md:border-0 bg-white">
                ...
                >
                  ...
                  <svg
                    className={`w-2.5 h-2.5 ml-2 transition-transform duration-300 ${
                      isDropdownOpenMakanan ? "rotate-180" : ""
                    }`}
                    viewBox="0 0 10 6"
                    fill="none"
                  >
                ...
                {isDropdownOpenMakanan && (
                  <div className="absolute z-10 left-0 mt-2 w-44 bg-white shadow-md rounded-lg">
                    <ul className="py-2 text-sm text-gray-700">
                      ...
                      <li>
                        <a className="flex items-center w-full px-4 py-2 hover:bg-gray-100">
                          {" "}
                          ERP
                        </a>
                      </li>
              ...
              <div className="relative" ref={menuRefProduk}>
                ...
                >
                  ...
                  <svg
                    className={`w-2.5 h-2.5 ml-2 transition-transform duration-300 ${
                      isDropdownOpenProduk ? "rotate-180" : ""
                    }`}
                    viewBox="0 0 10 6"
                    fill="none"
                  >
              ...
              <div className="relative" ref={menuRefBermita}>
                ...
                >
                  ...
                  <svg
                    className={`w-2.5 h-2.5 ml-2 transition-transform duration-300 ${
                      isDropdownOpenBermitra ? "rotate-180" : ""
                    }`}
                    viewBox="0 0 10 6"
                    fill="none"
                  >
        ...
        <div className="hidden md:block">
          <button className="text-white bg-[#F94917] px-5 py-2 rounded-lg me-2">
            Masuk
          </button>
          <button className="text-white bg-[#413D66] px-5 py-2 rounded-lg">
            Daftar
          </button>
        </div>
        ...
        <button
          ...
          type="button"
          class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hiddenfocus:outline-none hover:bg-gray-100 md:hidden"
        ...
        <div className="flex font-medium md:p-0 mt-1 mb-4 bg-gray-200 md:space-x-8 flex-col md:border-0 bg-white">
          <div className="relative" ref={menuRefMobileProduk}>
            ...
            >
              ...
              <svg
                className={`w-2.5 h-2.5 ml-2 transition-transform duration-300 ${
                  isDropdownOpenMakananMobile ? "rotate-180" : ""
                }`}
                viewBox="0 0 10 6"
                fill="none"
              >
          ...
          <div className="relative" ref={menuRefMobileProduk}>
            ...
            >
              ...
              <svg
                className={`w-2.5 h-2.5 ml-2 transition-transform duration-300 ${
                  isDropdownOpenProdukMobile ? "rotate-180" : ""
                }`}
                viewBox="0 0 10 6"
                fill="none"
              >
          ...
          <div className="relative" ref={menuRefMobileBermitra}>
            ...
            >
              ...
              <svg
                className={`w-2.5 h-2.5 ml-2 transition-transform duration-300 ${
                  isDropdownOpenBermitraMobile ? "rotate-180" : ""
                }`}
                viewBox="0 0 10 6"
                fill="none"
              >
          ...
          <button className="block text-white bg-[#F94917] py-2 px-3 mx-[6px] my-[2px] rounded-lg">
            Download App
          </button>
          <button className="block text-white bg-[#413D66] py-2 px-3 mx-[6px] my-[2px] rounded-lg">
            Admin gym
          </button>
        </div>
      </div>
