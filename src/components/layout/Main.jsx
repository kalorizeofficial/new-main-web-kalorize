    ...
    <div className="bg-white">
          ...
          <div className="max-w-screen-xl mx-auto flex flex-between flex-col-reverse md:flex-row">
            <div className="md:w-full md:pb-0 pb-20 md:pl-0 pl-3">
              <div className="rounded-full w-max p-4 md:mt-[80px] mt-[420px] bg-[#FEE9DE]  ">
                <p className="text-[#EB0029] text-[12px] font-medium font-[Poppins] inline-block mr-2">
                  Raih Tujuan Sehat Anda{" "}
                </p>
                <img
              ...
              <div className="md:max-w-[700px] mt-10">
                <p className="font-[Inter] font-extrabold text-4xl/[60px] md:text-[3vw]/[60px] text-[#413D66]">
                  Rekomendasi Makanan sesuai kebutuhan{" "}
                  <span className="font-[Lobster] text-[#F94917]">Protein</span>{" "}
                  &{" "}
                  <span className="font-[Lobster] text-[#F94917]">Kalori</span>{" "}
                  anda
                </p>
              </div>
              <div className="md:max-w-[500px] mt-5">
                <p className="font-[Inter] font-bold text-lg">
                  Temukan Makanan Sesuai Kebutuhan Anda dengan Kalorize. Makanan
                  yang Tepat, Hasil yang Maksimal{" "}
                </p>
              </div>
              <div className="rounded-full w-max p-4 bg-[#F94917]  md:mt-6 px-15 md:px-20 mt-7 ">
                <p className="text-white font-medium text-2xl md:text-xl font-[Poppins] ">
                  Get Started
                </p>
              </div>
            </div>
            <div className="relative md:w-full md:min-w-[530px] w-[300px] md:mx-0 mx-auto mt-[50px]">
              ...
              <div className="rounded-full md:w-max w-[150px] bg-white mt-6 flex md:justify-between absolute md:p-1 items-center md:gap-3 md:top-[410px] top-[220px] ">
                ...
                <div className="p-1 md:px-2 py-2 drop-shadow-xs">
                  <p className="font-[Poppins] font-medium md:text-sm text-[7px] mb-1">
                    Pilihan Makanan Beragam
                  </p>
                  <p className="font-[Poppins] text-[#828282] md:text-[8px] text-[5px]">
                    Makanan yang Tepat, Hasil yang Luar Biasa.
                  </p>
                </div>
              </div>
              <div className="rounded-xl  p-4 md:px-6 px-3 py-2 bg-white mt-6 flex justify-between items-center md:gap-3 gap-2 absolute md:top-[425px] top-[250px]  right-[0px]">
                ...
                <div>
                  <div>
                    <p className="font-[Poppins] font-medium mb-1 font-[Inter] font-normal text-[10px]">
                      Kalori
                    </p>
                  </div>
                  <div className="mt-[3px]">
                    <p className="font-[Poppins] text-[#828282] md:text-[13px] text-[8px] font-normal ">
                      <span className="text-[#F94917] font-bold">1986</span> /{" "}
                      <span className="text-[#4D555C] font-semibold">1981</span>{" "}
                      kcal
                    </p>
                  </div>
                  <div className="mt-[4px]">
                    <div className="rounded-full md:w-24 w-[70px]  border-1.5 border-[#1AB269] border-2 bg-[#E9FCF3] flex justify-around items-center justify-items-end">
                      <p className="text-[#1AB269] md:text-xs text-[8px]">
                        Terpenuhi
                      </p>
                      <img
                        className="md:w-[17px] w-[7px]"
                        src={Ceklis2}
                        alt=""
                      />
                    </div>
              ...
              <div className=" absolute md:w-[11px] w-[6px] md:h-[11px] h-[6px] md:rounded-[3.43px]  rounded-[1.5px] bg-[#EB0029] md:top-[370px] top-[230px] md:right-[0px] right-[0px]  rotate-45"></div>
              <div className=" absolute md:w-[11px] w-[6px] md:h-[11px] h-[6px] md:rounded-[3.43px] rounded-[1.5px] bg-[#EB0029] md:top-[340px] top-[210px] md:right-[80px] right-[45px] rotate-45"></div>
              <div className=" absolute md:w-[11px] w-[6px] md:h-[11px] h-[6px]  md:rounded-[3.43px] rounded-[1.5px] bg-[#EB0029] md:top-[530px] top-[350px] md:right-[300px] right-[130px] rotate-45"></div>
              <div className=" absolute md:w-[11px] w-[6px] md:h-[11px] h-[6px] md:rounded-[3.43px] rounded-[1.5px] bg-[#EB0029] md:top-[340px] top-[200px] md:right-[550px] right-[210px] rotate-45"></div>
              <div className=" absolute md:w-[11px] w-[6px] md:h-[11px] h-[6px] md:rounded-[3.43px] rounded-[1.5px] bg-[#EB0029] md:top-[140px] top-[100px] md:right-[550px] right-[240px] rotate-45"></div>
              <div className=" absolute md:w-[11px] w-[5px] md:h-[11px] h-[5px] rounded-full bg-[#F2C94C] md:top-[180px] top-[130px] md:right-[550px] right-[265px]"></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="p-4 md:pr-0 max-w-screen-xl mx-auto flex justify-between md:flex-row flex-col">
          <div className="md:w-full">
            <div className="mx-auto md:text-left text-center md:w-full w-[250px] md:mt-[300px]">
              <p className="text-[Inter] font-bold text-[#413D66] md:text-5xl text-3xl">
                Apa Itu <span className="text-[#F94917]">KALORIZE ?</span>{" "}
              </p>
            </div>
            <div className=" md:max-w-[540px] md:mt-15 mt-5 md:text-left text-center">
              <p className="font-[Inter] font-extrabold text-[#413D66] md:text-2xl/[40px] text-xl">
                {" "}
          ...
          <div className=" relative md:w-full md:min-w-[530px] w-[300px] md:mx-0 mx-auto mt-[50px]">
            <div className="bg-[#F94917] md:w-[120px] w-[75px] border-black md:py-2 py-1 md:h-[160px] rounded-xl absolute md:left-[calc(100%-530px)] left-[0px]  md:top-[250px] top-[130px] ">
              <div className="py-1">
                ...
                <div className=" mx-auto mt-2">
                  <p className="text-center md:text-xs text-[7px] font-medium text-white font-[Poppins]">
                    Kalori & Proteinmu Terpenuhi
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-full absolute flex md:top-[590px] md:right-[290px] right-[180px] md:p-2 md:py-2 py-2 p-1 z-10 items-center md:w-[250px] w-[150px] top-[306px] justify-around">
              ...
              <div className="md:w-[160px] w-[80px]">
                <p className="text-center md:text-sm text-[7px] font-medium">
                  AI Recomendation System
                </p>
              </div>
            </div>
            <div className=" absolute md:w-[10px] md:h-[10px] w-[5px] h-[5px] rounded-full bg-[#EB0029] md:top-[130px] top-[80px] md:right-[460px] right-[250px]"></div>
            <div className=" absolute w-[10px] h-[10px] rounded-full bg-[#EB0029] top-[370px] md:right-[0px]"></div>
      ...
      <div className="mt-[100px] w-full">
        <div className="text-center">
          <p className="text-[Inter] font-bold text-[#413D66] md:text-3xl text-3xl">
            Mengapa <span className="text-[#F94917]">Kalorize ?</span>{" "}
          </p>
        </div>
          ...
          <div className="flex justify-between md:mt-[30px] mt-[10px] md:flex-row flex-col">
            <div className="w-[300px] md:mx-0 mx-auto">
              ...
              <div className="text-center w-[250px] mx-auto ">
                <p className="font-[Poppins] text-sm mt-[20px]">
                  Terdapat lebih dari 43 ribu variasi menu makanan yang tersedia
                  di database kami
                </p>
              </div>
            </div>
            ...
            <div className="w-[280px] md:mx-0 mx-auto">
              ...
              <div className="text-center w-[250px] mx-auto">
                <p className="font-[Poppins] text-sm mt-[20px]">
                  Bekerjasama dengan nutrisionis untuk verifikasi data makanan
            ...
            <div className="w-[260px] md:mx-0 mx-auto">
              ...
              <div className="text-center w-[260px] mx-auto">
                <p className="font-[Poppins] text-sm mt-[20px]">
                  Menggunakan AI untuk memberikan rekomendasi terbaik sesuai
